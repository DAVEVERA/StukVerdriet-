        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-10 md:hidden">
          <div className="space-y-3 max-w-sm">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[#78A179] text-[9px] font-bold uppercase tracking-[0.28em]">Community</p>
            </div>
            <h1 className="font-serif text-white font-bold leading-[1.15] drop-shadow-lg">
              <span className="block text-[30px]">Deel je verhaal.</span>
              <span className="block text-[30px]">Voor elkaar.</span>
              <span className="block text-[30px] text-[#78A179]">Met elkaar.</span>
            </h1>
            <div className="w-12 h-[2px] bg-[#78A179] rounded-full" />
            <p className="text-white/65 text-[15px] leading-relaxed font-light">
              Jouw verhaal telt.<br />
              Deel wat jij hebt meegemaakt.<br />
              Anderen herkennen zich erin.
            </p>
          </div>
        </div>
          ...
          <div className="container mx-auto px-6 max-w-7xl pt-20">
            <div className="max-w-lg space-y-5 drop-shadow-xl">
              ...
              <h1 className="font-serif text-white font-bold leading-[1.2]">
                <span className="block text-[40px] lg:text-[52px]">Deel je verhaal.</span>
                <span className="block text-[40px] lg:text-[52px]">Voor elkaar.</span>
                <span className="block text-[40px] lg:text-[52px] text-[#78A179]">Met elkaar.</span>
              </h1>
